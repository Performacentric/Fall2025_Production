...
export const ImproveEfficiency: React.FC = () => {
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative w-full h-[250px] md:h-[350px] flex items-center justify-center overflow-hidden">
        ...
        <h1 className="relative z-10 text-white text-3xl md:text-5xl font-bold text-center px-4 [font-family:'Manrope',Helvetica]">
          Continuous Innovation for Improved Efficiency
        </h1>
      </section>
      ...
      <section className="w-full py-12 md:py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-center text-gray-600 max-w-3xl mx-auto mb-12 text-sm md:text-base leading-relaxed [font-family:'Manrope',Helvetica]">
            Performacentric helps small and mid-market companies improve efficiency by deploying agentic AI systems that streamline processes, reduce manual work, and ensure data-driven decisions across every business function. The result is faster execution, lower operational costs, and more productive teams.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
            <div className="flex flex-col items-center text-center">
              <h3 className="text-lg md:text-xl font-bold text-gray-800 mb-6 [font-family:'Manrope',Helvetica]">
                End-to-End Process<br />Automation
              </h3>
              <div className="space-y-4 text-sm text-gray-600 [font-family:'Manrope',Helvetica]">
                <p>Automate repetitive workflows across operations, finance, marketing, sales, and service.</p>
              </div>
            </div>

            <div className="flex flex-col items-center text-center">
              <h3 className="text-lg md:text-xl font-bold text-gray-800 mb-6 [font-family:'Manrope',Helvetica]">
                Real-Time Data Integration<br />and Visibility
              </h3>
              <div className="space-y-4 text-sm text-gray-600 [font-family:'Manrope',Helvetica]">
                <p>Integrate data across ERP, CRM, POS, and marketing systems into a single AI-driven performance hub.</p>
              </div>
            </div>

            <div className="flex flex-col items-center text-center">
              <h3 className="text-lg md:text-xl font-bold text-gray-800 mb-6 [font-family:'Manrope',Helvetica]">
                Intelligent Workflow<br />Optimization
              </h3>
              <div className="space-y-4 text-sm text-gray-600 [font-family:'Manrope',Helvetica]">
                <p>Continuously monitor workflows and identify inefficiencies.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            <div className="text-white">
              <h2 className="text-2xl md:text-3xl font-bold mb-6 [font-family:'Manrope',Helvetica]">
                Efficiency Improvement Workshop
              </h2>
