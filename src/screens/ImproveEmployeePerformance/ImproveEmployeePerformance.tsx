...
export const ImproveEmployeePerformance: React.FC = () => {
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative w-full h-[250px] md:h-[350px] flex items-center justify-center overflow-hidden">
        ...
        <h1 className="relative z-10 text-white text-3xl md:text-5xl font-bold text-center px-4 [font-family:'Manrope',Helvetica]">
          Continuous Innovation for Better Performing Employees
        </h1>
      </section>
      ...
      <section className="w-full py-12 md:py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-800 mb-6 [font-family:'Manrope',Helvetica]">
            Improve Employee<br />Performance
          </h2>
          ...
          <p className="text-center text-gray-600 max-w-3xl mx-auto mb-12 text-sm md:text-base leading-relaxed [font-family:'Manrope',Helvetica]">
            Performacentric helps small and mid-market companies improve employee performance by combining AI-driven insights, automation, and continuous innovation frameworks to align individual productivity with organizational goals. Our platform transforms how employees work, learn, and contribute- making performance management more intelligent, data-driven, and motivational.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
            <div className="flex flex-col items-center text-center">
              <h3 className="text-lg md:text-xl font-bold text-gray-800 mb-6 [font-family:'Manrope',Helvetica]">
                Intelligent Performance<br />Visibility
              </h3>
              <div className="space-y-4 text-sm text-gray-600 [font-family:'Manrope',Helvetica]">
                <p>Give managers real-time visibility into individual and team output across all systems.</p>
                <p>Continuously analyze productivity patterns, quota attainment, customer satisfaction scores and present performance goals-early.</p>
              </div>
            </div>

            <div className="flex flex-col items-center text-center">
              <h3 className="text-lg md:text-xl font-bold text-gray-800 mb-6 [font-family:'Manrope',Helvetica]">
                Personalized Coaching and<br />Goal Alignment
              </h3>
              <div className="space-y-4 text-sm text-gray-600 [font-family:'Manrope',Helvetica]">
                <p>Use predictive analytics to identify skill gaps and recommend micro-learning modules, or workflow adjustments tailed to each employee.</p>
                <p>Employees receive AI-guided feedback loops that improve day-to-day decisions and long-term growth.</p>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="space-y-4 text-sm text-gray-600 [font-family:'Manrope',Helvetica]">
                <p>AI-powered feedback systems identify emerging best practices and scale them across teams.</p>
                <p>Over time, the workforce becomes more agile, adaptive, and performance-oriented.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            <div className="text-white">
              ...
              <ul className="space-y-2 text-sm [font-family:'Manrope',Helvetica]">
                <li>• Intelligent Performance Visibility</li>
                <li>• Personalized Coaching and Goal Alignment</li>
                <li>• Process Automation</li>
                <li>• Data-Driven Incentives and Employee Motivation</li>
              </ul>
            </div>
